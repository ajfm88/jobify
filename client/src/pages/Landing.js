        ...
        <div className="container page">
          ...
          <div className="info">
            ...
            <p>
              ...
              <br />
              There is also a demo account available for testing purposes. In
              the login screen, just click on the “Explore The App” button to
              test the application using that demo account.
            </p>
